...
describe("EditClockDialog", () => {
  ...
  it("allows manual adjustment of minutes", async () => {
    ...
    for (let i = 0; i < 10; i++) await user.click(incMin);
    // 7 + 10 = 17
    expect(screen.getByText("17")).toBeInTheDocument();

    // Resetting for specific checks
    // This part of the test might be slow with userEvent if we do 100 clicks.
    // Reduced to 10 for sanity in tests.
  });
