...
interface UseGameModeActionsParams {
  ...
  team: { defaultFoulLimit?: number; periodType?: "QUARTERS" | "HALVES" } | null | undefined;
    ...
    async (currentType?: string) => {
      ...
      try {
        ...
        if (isEditing && editingStatId) {
          ...
          const maxPeriod = (teamRef?.periodType || "QUARTERS") === "HALVES" ? 2 : 4;
          const isSuccessfulFieldGoal = typeToSave === ACTION_TYPES.MAKE && points > 1;
