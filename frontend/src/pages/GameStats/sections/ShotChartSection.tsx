...
interface ShotChartSectionProps {
  ...
  setSelectedPlayerId: (_v: number | string) => void;
  selectedType: string;
  setSelectedType: (_v: string) => void;
  selectedQuality: string;
  setSelectedQuality: (_v: string) => void;
  selectedBreakdown: string;
  setSelectedBreakdown: (_v: string) => void;
  selectedPlay: string;
  setSelectedPlay: (_v: string) => void;
  compareMode: boolean;
  setCompareMode: (_v: boolean) => void;
  shotChartView: "markers" | "heatmap";
  setShotChartView: (_v: "markers" | "heatmap") => void;
