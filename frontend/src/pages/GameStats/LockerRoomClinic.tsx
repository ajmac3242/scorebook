    ...
    <Box sx={{ mt: 3 }}>
      ...
      >
        <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 3 }}>
          ...
          <Typography
            variant="h5"
            sx={{ fontWeight: 800, fontFamily: "var(--serif)" }}
          >
            LOCKER ROOM CLINIC
          </Typography>
        </Stack>
            ...
            >
              ...
              <Box sx={{ flexGrow: 1 }}>
                <Typography variant="body2" sx={{ fontWeight: 700 }}>
                  {m.type === "WIN" ? "Execution Win" : "Tactical Error"} -
                  Period {m.period} ({formatClock(m.clockTime)})
                </Typography>
              ...
              <Tooltip
                title={
                  m.type === "WIN"
                    ? "High-efficiency execution (> 1.2 PPP)"
                    : "Low-efficiency execution (< 0.8 PPP)"
                }
              >
                <Chip
                  label={`PPP: ${m.ppp}`}
