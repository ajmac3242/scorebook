...
type AddGameDialogProps = {
  ...
  newOpponent: string;
  setNewOpponent: (v: string) => void;
  newOpponentId: string | undefined;
  setNewOpponentId: (v: string | undefined) => void;
  newOpponentLogoUrl: string;
  setNewOpponentLogoUrl: (v: string) => void;
  newDate: string;
  ...
  setNewPeriodType: (v: "QUARTERS" | "HALVES") => void;
  newPeriodLength: number;
  setNewPeriodLength: (v: number) => void;
  newTimeoutLimit: number;
  setNewTimeoutLimit: (v: number) => void;
  newFoulLimit: number;
  setNewFoulLimit: (v: number) => void;
  newTacticalKpis: string[];
  setNewTacticalKpis: (v: string[]) => void;
