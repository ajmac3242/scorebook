...
type TeamSettingsDialogProps = {
  ...
  setEditPeriodType: (v: "QUARTERS" | "HALVES") => void;
  editPeriodLength: number;
  setEditPeriodLength: (v: number) => void;
  editOvertimeLength: number;
  setEditOvertimeLength: (v: number) => void;
  editMaxStintDuration: number;
  setEditMaxStintDuration: (v: number) => void;
  editTimeoutLimit: number;
  setEditTimeoutLimit: (v: number) => void;
  editFoulLimit: number;
  setEditFoulLimit: (v: number) => void;
  editFoulWarningThresholds: Record<string, number>;
  setEditFoulWarningThresholds: (v: Record<string, number>) => void;
  editPlaybook: string[];
  setEditPlaybook: (v: string[]) => void;
  newPlayName: string;
