  ...
  describe("calculateDefensiveIntegrity", () => {
    it("groups points allowed by breakdown reason", () => {
      const stats: StatEvent[] = [
        { playerId: SPECIAL_PLAYER_IDS.OPPONENT, type: ACTION_TYPES.MAKE, points: 2, breakdownReason: "Middle-Drive", timestamp: "1" },
        { playerId: SPECIAL_PLAYER_IDS.OPPONENT, type: ACTION_TYPES.MAKE, points: 3, breakdownReason: "Middle-Drive", timestamp: "2" },
        { playerId: SPECIAL_PLAYER_IDS.OPPONENT, type: ACTION_TYPES.MAKE, points: 2, breakdownReason: "Baseline-Leak", timestamp: "3" },
      ];
