...
describe("lineups analytics", () => {
  ...
  describe("calculatePlayerAggregates", () => {
    ...
    it("should handle multi-game aggregates", () => {
      const stats: StatEvent[] = [
        { gameId: "g1", playerId: "p1", type: ACTION_TYPES.MAKE, points: 2, timestamp: "1" },
        { gameId: "g2", playerId: "p1", type: ACTION_TYPES.MAKE, points: 3, timestamp: "2" },
      ];
    ...
    it("should calculate averages correctly", () => {
      const stats: StatEvent[] = [
        { gameId: "g1", playerId: "p1", type: ACTION_TYPES.MAKE, points: 2, timestamp: "1" },
        { gameId: "g2", playerId: "p1", type: ACTION_TYPES.MAKE, points: 4, timestamp: "2" },
      ];
