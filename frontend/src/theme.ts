...
const theme = createTheme({
  ...
  typography: {
    ...
    h4: { fontWeight: 500, color: '#2D2D2D', fontFamily: 'system-ui, sans-serif' },
    h5: { fontWeight: 500, color: '#2D2D2D', fontFamily: 'system-ui, sans-serif' },
    h6: { fontWeight: 500, color: '#2D2D2D', fontFamily: 'system-ui, sans-serif' },
    button: {
      textTransform: 'none',
      fontWeight: 500,
