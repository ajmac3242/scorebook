...
describe('LiveLineupCard', () => {
  ...
  it('renders chain prompt card when chainPrompt is provided', () => {
    const chainPrompt = { type: 'REBOUND', originalStat: { period: 1, clockTime: '5:00', timestamp: 123 } } as any;
  ...
  it('calls onDismissChain when dismiss button is clicked in chain prompt', () => {
    const chainPrompt = { type: 'ASSIST', originalStat: { period: 1, clockTime: '3:00', timestamp: 456 } } as any;
    render(<LiveLineupCard {...defaultProps} chainPrompt={chainPrompt} />);
