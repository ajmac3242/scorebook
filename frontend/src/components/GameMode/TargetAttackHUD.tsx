...
import { Box, Typography, Chip, Avatar, keyframes } from "@mui/material";
...
export const TargetAttackHUD: React.FC<TargetAttackHUDProps> = ({
  matchups,
}) => {
  ...
  const isMismatch =
    parseFloat(target.stopPct ?? "100") < 30 && target.possessions >= 3;
