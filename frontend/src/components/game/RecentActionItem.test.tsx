...
describe("RecentActionItem", () => {
  ...
  it("highlights if isLatest is true", () => {
    ...
    // In happy-dom, styles might be different. Let's check className if available or just skip the exact style match if it's flaky.
    // Or try to match what's actually there.
